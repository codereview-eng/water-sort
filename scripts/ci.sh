...
#   门禁 2  多语言静态 gate：字典对等/en 无 CJK/screens 英文安全 fallback/内嵌副本同步
#           （i18n-parity.test.js + i18n-no-cjk-leak.test.js；含在门禁 1 内，这里单独报结论）
...
line "门禁 2/3 · 多语言静态 gate（字典对等 / en 无中文 / screens 英文安全 fallback / 内嵌副本同步）"
